...
for case_now = INPUTS.cases
    ...
    if any([INPUTS.events_weights.ds,INPUTS.events_weights.re,INPUTS.events_weights.le])
        ...
        if any(INPUTS.events_weights.ds)
        ...
        if any(INPUTS.events_weights.re)
        ...
        if any(INPUTS.events_weights.le)
