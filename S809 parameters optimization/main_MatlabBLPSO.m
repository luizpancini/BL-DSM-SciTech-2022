...
M_0150_cases = [381 382 383 393 394 395 405 406 407 417 418 419 429 430 431 441 442 443];    % M = 0.150
...
events_weights = [0, 0, 0];         % Stall onset, reattachment, loads extrema
%%% Algorithm options
...
set_GP = 0; specified_filename = 'gBestMat_036.mat';
% Number of particles
N = 120; 
...
N_cases = [N_runs_M_0075,N_runs_M_0100,N_runs_M_0125,N_runs_M_0150,N_runs_all_cases,N_runs_custom_cases];
